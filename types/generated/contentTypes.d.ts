...
export interface ApiFeatureSectionFeatureSection
  ...
  attributes: {
    card1Desc: Schema.Attribute.Text;
    card1Icon: Schema.Attribute.String;
    card1Title: Schema.Attribute.String;
    card2Desc: Schema.Attribute.Text;
    card2Icon: Schema.Attribute.String;
    card2Title: Schema.Attribute.String;
    card3Desc: Schema.Attribute.Text;
    card3Icon: Schema.Attribute.String;
    card3Title: Schema.Attribute.String;
    card4Desc: Schema.Attribute.Text;
    card4Icon: Schema.Attribute.String;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    cartButtonText: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    siteNameHighlight: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductSectionHeadingProductSectionHeading
  extends Struct.SingleTypeSchema {
  collectionName: 'product_section_headings';
  info: {
    displayName: 'ProductSectionHeading';
    pluralName: 'product-section-headings';
    singularName: 'product-section-heading';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-section-heading.product-section-heading'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subheading: Schema.Attribute.Text;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    fabricText: Schema.Attribute.String;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::product-section-heading.product-section-heading': ApiProductSectionHeadingProductSectionHeading;
